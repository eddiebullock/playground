#!/bin/bash
# HPC script for fine-tuning I3D and TimeSformer models (CPU)
# This script is called by the SLURM submission script

set -e

# Configuration (adjust paths for HPC)
# EU emotions data is on RDS (not /home to avoid quota issues)
# Data location: ~/rds/rds-autism-research-ePtR33Nsgi4/data/EU_emotions
...
NUM_WORKERS=4  # More workers on HPC

echo "=========================================="
echo "Fine-tuning I3D and TimeSformer models on HPC (CPU)"
echo "=========================================="
echo ""
echo "Data root: $DATA_ROOT"
echo "Train trials: $TRAIN_TRIALS"
echo "Val trials: $VAL_TRIALS"
echo "Device: CPU (auto-detect)"
echo ""
